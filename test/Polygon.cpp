...
TEST_CASE("Geometry") {
    SECTION("Convex polygon") {
        ...
        SECTION("Geometric properties") {
            ...
            REQUIRE(all(furthestVertexInDirection(square, Vec2{1, 1}) == Vertex{1.f, 1.f}));
        }
        ...
        SECTION("Degenerate polygon") {
            ...
            REQUIRE(all(furthestVertexInDirection(line, Vec2{1, 1}) == Vertex{2.f, 2.f}));
        }
        ...
        SECTION("With holes") {
            ...
            REQUIRE(all(furthestVertexInDirection(box, Vec2{1, 1}) == Vertex{4.f, 4.f}));
        }
    }
}